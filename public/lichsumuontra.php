...
<body>
    ...
    <div class="container mx-auto">
        <h2 class="text-2xl font-bold mb-4 uppercase text-center mt-4">Lịch sử mượn trả</h2>
        ...
        <div class="mt-4">
            ...
            <div id="statistics" class="hidden mt-4 flex justify-between border border-gray-300 rounded-md p-4">
                <h3 class="font-bold">Thống kê:</h3>
                <div class="ml-4 border-2 border-indigo-600 rounded">Số lượng phiếu mượn đã được trả: <?php echo $daTraCount; ?></div>
                <div class="ml-4 border-2 border-indigo-600 rounded">Số lượng phiếu mượn đang còn mượn: <?php echo $dangMuonCount; ?></div>
            </div>
